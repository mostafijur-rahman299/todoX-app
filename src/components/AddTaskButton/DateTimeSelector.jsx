...
const DateTimeSelector = ({
	...
	const handleDateTimeSelect = (option) => {
		...
		if (initialDate) {
			...
			const endDateTime = new Date(
				initialDate.getTime() + duration * 60 * 1000,
			);
	...
	const handleDurationChange = (newDuration) => {
		...
		const newEndTime = new Date(
			startTime.getTime() + newDuration * 60 * 1000,
		);
		setEndTime(newEndTime);
	};
	...
	const getDateTimeDisplay = () => {
		...
		const date = new Date(task.date + "T" + (task.startTime || "00:00"));
		const now = new Date();
							...
							{task.date && (
								<View style={styles.currentSelectionContainer}>
									<View style={styles.currentSelection}>
										...
										/>
										<Text
											style={styles.currentSelectionText}>
											{getDateTimeDisplay()}
										</Text>
										<TouchableOpacity
						...
						<View style={styles.dateRangeContainer}>
							<View style={styles.datePickerHeader}>
								<TouchableOpacity
									...
									<Text style={styles.datePickerButtonCancel}>
										Cancel
									</Text>
								</TouchableOpacity>
							...
							<ScrollView
								...
								<View style={styles.dateTimeSection}>
									...
									<TouchableOpacity
										...
										/>
										<Text
											style={styles.dateTimeSelectorText}>
								...
								<View style={styles.summarySection}>
									...
									<View style={styles.summaryCard}>
										...
										<Text
											style={styles.summaryDurationText}>
											Duration:{" "}
											{duration < 60
												? `${duration} minutes`
												: `${duration / 60} hour${
